...
curl_setopt_array($curl, array(
	...
	CURLOPT_POSTFIELDS => "client_id=3MVG9g9rbsTkKnAXEHsxzO08QzDD2_0GnIedlmVrxZWJcZtP_A8dGjmuGcDlZjeqXCEUgjUxIp_Sau3voeK1v&client_secret=1687696237180270615&grant_type=password&username=$user&password=$pass",
...
//End Connection 
			...
			$query = "SELECT id,Number_of_Bathrooms__c,Number_Of_Bedrooms__c,Price__c,Property_Image__c,Sold__c,Type__c,Zipcode__c,Address__c from Property_Detail__c WHERE Sold__c != true ";
        ...
        <div class="container-fluid">
            <div class="col-xs-4 templatemo_logo">
            	<a href="#">
                	...
                	<h1 id="logo_text">Property<span>Detail</span></h1>
                </a>
...
">
                    <div>Property Type:  <?php echo $values->Type__c; ?></div>
					<div>Property Price:  <?php echo $values->Price__c; ?></div>
					<div>Property Address:  <?php echo $values->Address__c; ?></div>
					<div>Zipcode:  <?php echo $values->Zipcode__c; ?></div>
				</div>
				<div style="
    float: right;
">
					<div>Number of Bathrooms:  <?php echo $values->Number_of_Bathrooms__c; ?></div>
					<div>Number of Bedrooms:  <?php echo $values->Number_Of_Bedrooms__c; ?></div>
...
<div id="templatemo_footer">
    <div>
        <p id="footer">Copyright &copy; 2017 Yorkshire Hathaway</p>
    </div>
</div>
